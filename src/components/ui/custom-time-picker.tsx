...
export const CustomTimePicker: React.FC<CustomTimePickerProps> = ({
  ...
  return (
    <Popover open={open} onOpenChange={setOpen}>
      ...
      >
        {/* Header */}
        <div className="bg-[#7B0099] text-white px-4 py-2.5 text-center font-bold text-sm shadow-sm flex items-center justify-between">
        ...
        <div className="flex items-center justify-between px-3 py-2 border-t border-border/40 bg-muted/20">
          <button
            type="button"
            onClick={handleNow}
            className="text-xs font-bold text-[#7B0099] hover:text-[#5e0080] transition-colors py-1 px-2.5 rounded hover:bg-[#7B0099]/10 cursor-pointer"
          >
            Now
          </button>
          <button
            ...
            className="text-xs font-bold text-white bg-[#7B0099] hover:bg-[#5e0080] transition-colors py-1 px-3 rounded shadow-xs cursor-pointer"
          >
            Done
          </button>
        </div>
