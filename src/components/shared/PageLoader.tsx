  ...
  return (
    ...
    >
      <div className="flex flex-col items-center gap-4 bg-white/80 dark:bg-slate-900/60 p-7 px-9 rounded-[32px] border border-white/40 dark:border-white/5 shadow-2xl animate-in fade-in zoom-in-95 duration-300">
        <div className="w-14 h-14 drop-shadow-[0_8px_16px_rgba(22,53,186,0.2)]">
          {/* Custom clock SVG provided by the user */}
          <svg fill="hsl(228, 97%, 42%)" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
        ...
        <div className="flex flex-col items-center gap-0.5">
          <p className="text-[11px] font-black uppercase tracking-[0.25em] text-[#1635ba] dark:text-[#4a6bf5] animate-pulse">
            Syncing
          </p>
