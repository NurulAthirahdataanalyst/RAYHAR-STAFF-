      ...
      <div className="p-6">
        ...
        <div className="mt-6 bg-slate-50/80 dark:bg-slate-900/60 rounded-2xl p-4 border border-slate-100 dark:border-slate-800 flex items-center justify-between">
          ...
          <button 
            ...
            className="flex items-center gap-2 bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 shadow-sm hover:bg-slate-50 dark:hover:bg-slate-700 text-[#942392] dark:text-purple-300 hover:text-[#7a1d78] dark:hover:text-purple-200 font-bold text-sm px-4 py-2.5 rounded-xl transition-colors"
          >
