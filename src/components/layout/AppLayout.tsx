        ...
        <div className="relative p-4 sm:p-6 lg:p-6 max-w-[1400px] mx-auto animate-in fade-in slide-in-from-bottom-4 duration-700">
          ...
          <div className="flex flex-col lg:flex-row gap-6 lg:gap-6 items-start relative w-full">
            ...
            {resolvedRole !== "employee" && (
              <aside 
                className={`hidden lg:flex flex-col shrink-0 transition-all duration-500 ease-in-out relative border-l border-border/20 pl-4 py-1 sticky top-6 max-h-[calc(100vh-48px)] overflow-visible ${
              ...
              <div className="flex-1 w-full overflow-y-auto overflow-x-visible scrollbar-none flex flex-col gap-6 items-center lg:items-stretch py-1 pr-0.5">
                {!sidebarCollapsed ? (
                  <>
                    {/* ═══════ PENDING APPROVALS ═══════ */}
                    {["hr_admin", "branch_leader", "managing_director", "finance_manager", "head_of_department"].includes(resolvedRole) && (
                      <div className="bg-[#7B0099] p-6 rounded-[20px] shadow-lg text-white relative overflow-hidden group w-full transition-all duration-500">
                    ...
                    {["hr_admin", "managing_director"].includes(resolvedRole) ? (
                      ...
                      <div className="bg-card/85 dark:bg-card/40 backdrop-blur-md p-6 rounded-[20px] shadow-xl border border-white/40 dark:border-white/10 w-full">
                        ...
                        <div className="mb-5 rounded-[16px] bg-white/45 dark:bg-black/20 p-3 border border-white/30 dark:border-white/5">
