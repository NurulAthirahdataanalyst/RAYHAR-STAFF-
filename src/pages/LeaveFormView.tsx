    ...
    try {
      ...
      const formatted = data.leaveRequests.map((request: any) => {
        ...
        return {
          ...
          pending_approver_name: request.pending_approver_name,
    ...
    <div className="space-y-4 sm:space-y-6 animate-in fade-in duration-500">
        ...
        <div className="mb-4 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex items-center gap-3">
            ...
            <Button
              ...
              className="gap-2 bg-card border border-border/50 text-foreground hover:bg-muted rounded-xl font-black text-[8px] print:text-[10px] uppercase tracking-widest px-4 shadow-sm transition-all active:scale-95"
            >
            ...
            <Button
              ...
              className="gap-2 bg-[#942392] text-white hover:bg-[#5e0080] rounded-xl font-black text-[8px] print:text-[10px] uppercase tracking-widest px-4 shadow-sm transition-all active:scale-95"
            >
      ...
      <Card className="border-none shadow-[0_20px_50px_rgba(0,0,0,0.04)] dark:shadow-[0_20px_50px_rgba(0,0,0,0.2)] bg-card/80 backdrop-blur-md rounded-[24px] sm:rounded-[32px] overflow-hidden">
        <CardContent className="p-0">
          <div className="px-6 pt-4 border-b border-gray-200 dark:border-slate-800 bg-white/50 dark:bg-slate-900/50 flex flex-col sm:flex-row justify-between items-start sm:items-end gap-4">
            <div className="flex items-center gap-6 overflow-x-auto w-full sm:w-auto scrollbar-none">
              {([
                { key: "history" as FormTabFilter, label: "History", count: monthFilteredForms.length, color: "text-[#942392]", border: "border-[#942392]", hoverText: "hover:text-[#942392]", hoverBorder: "hover:border-[#942392]", bgBadge: "bg-[#942392]", hoverBadge: "group-hover:bg-[#942392]" },
                { key: "pending" as FormTabFilter, label: "Pending", count: pendingCount, color: "text-amber-500", border: "border-amber-500", hoverText: "hover:text-amber-500", hoverBorder: "hover:border-amber-500", bgBadge: "bg-amber-500", hoverBadge: "group-hover:bg-amber-500" },
                { key: "approved" as FormTabFilter, label: "Approved", count: approvedCount, color: "text-emerald-500", border: "border-emerald-500", hoverText: "hover:text-emerald-500", hoverBorder: "hover:border-emerald-500", bgBadge: "bg-emerald-500", hoverBadge: "group-hover:bg-emerald-500" },
                { key: "rejected" as FormTabFilter, label: "Rejected", count: rejectedCount, color: "text-red-500", border: "border-red-500", hoverText: "hover:text-red-500", hoverBorder: "hover:border-red-500", bgBadge: "bg-red-500", hoverBadge: "group-hover:bg-red-500" }
              ]).map((tab) => (
                <button
                  key={tab.key}
                  role="tab"
                  ...
                  className={`group text-sm font-black uppercase tracking-widest pb-3 translate-y-[1px] transition-colors border-b-[3px] whitespace-nowrap ${
                    activeTab === tab.key 
                      ...
                      : `text-foreground border-transparent ${tab.hoverText} ${tab.hoverBorder}`
                  }`}
                >
                  {tab.label}
                  {tab.count > 0 && (
            ...
            <div className="pb-3 flex items-center gap-3 w-full sm:w-auto justify-end">
              <Badge variant="outline" className="font-black text-[8px] print:text-[10px] px-3 py-1 bg-white/50 dark:bg-black/20 border-border/50 text-foreground">
          ...
          {loading ? (
              ...
              <div className="overflow-x-auto hidden sm:block">
                <Table>
                  <TableHeader className="bg-muted/30">
                    <TableRow>
                      <TableHead className="px-6 py-4 text-[8px] print:text-[10px]">Leave Type</TableHead>
                      <TableHead className="px-6 py-4 text-[8px] print:text-[10px]">From</TableHead>
                      <TableHead className="px-6 py-4 text-[8px] print:text-[10px]">To</TableHead>
                      <TableHead className="px-6 py-4 text-[8px] print:text-[10px] text-center">Days</TableHead>
                      <TableHead className="px-6 py-4 text-[8px] print:text-[10px] text-center">Status</TableHead>
                  ...
                  >
                    <div className="flex items-center justify-between gap-4">
                      ...
                      <div className="flex flex-col items-end gap-2 shrink-0">
                        <Badge
                          className={`text-[9px] print:text-[11px] font-black px-2 py-1 h-auto shadow-sm whitespace-nowrap ${
            ...
            <div className="py-20 text-center flex flex-col items-center gap-4 animate-in fade-in zoom-in duration-500">
              ...
              <div className="space-y-1 print:space-y-1.5">
                ...
                <p className="text-[8px] print:text-[10px] font-medium text-foreground italic">
              ...
              {activeTab === "history" && (
                <Button
                  variant="outline"
                  onClick={() => navigate("/leave/apply")}
                  className="mt-2 rounded-xl border-[#942392] text-[#942392] hover:bg-[#942392]/5 font-black text-[8px] print:text-[10px] uppercase tracking-widest"
                >
