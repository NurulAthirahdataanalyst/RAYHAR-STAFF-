import { FileSearch, CalendarDays, CheckCircle, XCircle, Construction } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mt-6 rounded-2xl overflow-hidden border border-border shadow-sm bg-card">
          ...
          <div className="p-10 flex flex-col items-center text-center gap-6">
            ...
            <div>
              <h2 className="text-2xl font-black text-foreground mb-2">Team Leave Requests</h2>
              <p className="text-sm text-muted-foreground max-w-md">
                Monitor all leave submissions from employees within your department or branch.
                Track leave balances, spot coverage gaps, and stay informed of your team's schedule.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          {[
            { icon: CalendarDays, title: "Leave Calendar", desc: "View all upcoming leaves in a calendar to manage team availability." },
            { icon: CheckCircle, title: "Approved Leaves", desc: "See approved leave history for all team members month by month." },
            { icon: XCircle, title: "Pending Requests", desc: "Quick summary of leave requests awaiting review or approval." },
          ].map((f) => (
