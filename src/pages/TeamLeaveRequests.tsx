                ...
                <div className="rounded-[24px] border border-border/50 p-4 sm:p-6 space-y-4 bg-card shadow-sm">
                  ...
                  <div className="grid grid-cols-2 gap-4 text-[13px] font-bold">
                    <div className="space-y-1">
                      ...
                      <p className="border-b pb-1 border-border/40 break-words font-bold">{selectedRequest.employee}</p>
                    </div>
                    <div className="space-y-1">
                  ...
                  <div className="pt-4 border-t border-border/50 space-y-4">
                    ...
                    <div className="grid grid-cols-2 gap-4 bg-muted/20 p-4 rounded-[20px]">
                      <div className="space-y-1">
                        ...
                        <p className="text-[13px] font-bold truncate">{selectedRequest.warisNama}</p>
                      </div>
                      <div className="space-y-1">
                        <span className="text-[12px] font-black text-slate-950 dark:text-slate-50 uppercase">Hubungan</span>
                        <p className="text-[13px] font-bold truncate">{selectedRequest.warisHubungan}</p>
                      </div>
                      <div className="space-y-1">
                      ...
                      <div className="space-y-1">
                        ...
                        <p className="text-[13px] font-bold break-words">{selectedRequest.warisAlamat}</p>
                      </div>
                    </div>
                  </div>
