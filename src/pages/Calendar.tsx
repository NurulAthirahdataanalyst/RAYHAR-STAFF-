      ...
      <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center mb-6 gap-4">
        ...
        <div className="flex flex-wrap items-center gap-3 w-full sm:w-auto">
          ...
          <Button 
            ...
            className="bg-[#FAF129] hover:bg-[#F2E820] text-[#1E293B] gap-2 font-bold px-6 shadow-sm shadow-[#FAF129]/20"
          >
            Create
          </Button>
        </div>
            ...
            <div className="p-4">
              <CalendarComponent
                ...
                classNames={{
                  ...
                  day_selected: "bg-[#FAF129] text-[#1E293B] hover:bg-[#F2E820] hover:text-[#1E293B] focus:bg-[#FAF129] focus:text-[#1E293B]",
                ...
                <div className="mt-4 p-4 bg-muted/30 rounded-xl border border-border space-y-4 animate-in fade-in zoom-in-95 duration-200">
                  ...
                  <div className="flex items-center justify-end gap-2 pt-3 border-t border-border/60">
                    ...
                    <button 
                      ...
                      className="px-4 py-1.5 text-xs font-bold bg-[#FAF129] text-[#1E293B] rounded-md shadow-sm hover:bg-[#F2E820] transition-colors"
                    >
                      Add Category
                    </button>
                  </div>
          ...
          <div className="flex flex-col sm:flex-row items-center justify-between p-4 border-b border-border/60 gap-4">
            ...
            <div className="flex items-center bg-muted/40 rounded-lg p-1 border border-border/50 w-full justify-center sm:w-auto">
              <button 
                ...
                className={`px-5 py-1.5 rounded-md text-sm font-bold shadow-sm transition-colors ${viewMode === 'month' ? 'bg-[#FAF129] text-[#1E293B]' : 'text-muted-foreground hover:text-foreground'}`}>Month</button>
              <button 
                onClick={() => setViewMode('week')}
                className={`px-5 py-1.5 rounded-md text-sm font-bold shadow-sm transition-colors ${viewMode === 'week' ? 'bg-[#FAF129] text-[#1E293B]' : 'text-muted-foreground hover:text-foreground'}`}>Week</button>
          ...
          <div className="bg-card w-full max-w-md rounded-2xl shadow-2xl border border-border/60 overflow-hidden animate-in zoom-in-95 duration-200">
            ...
            <form onSubmit={handleAddEvent} className="p-5 space-y-4">
              ...
              <div className="flex items-center gap-4 pt-4 border-t border-border/60">
                ...
                <Button type="submit" className="bg-[#FAF129] hover:bg-[#F2E820] text-[#1E293B] font-bold px-6 shadow-md shadow-[#FAF129]/20">
                  Add Event
                </Button>
              </div>
            </form>
