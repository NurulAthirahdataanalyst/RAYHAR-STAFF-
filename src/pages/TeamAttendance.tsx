import { Users, Clock, CalendarDays, TrendingUp, Construction } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mt-6 rounded-2xl overflow-hidden border border-border shadow-sm bg-card">
          ...
          <div className="p-10 flex flex-col items-center text-center gap-6">
            ...
            <div>
              <h2 className="text-2xl font-black text-foreground mb-2">Team Attendance</h2>
              <p className="text-sm text-muted-foreground max-w-md">
                View the real-time attendance status of all employees within your department or branch.
                Includes check-in/out times, lateness tracking, and absenteeism reports.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          {[
            { icon: Users, title: "Team Overview", desc: "See present, absent, and on-leave counts for your team at a glance." },
            { icon: Clock, title: "Check-In / Check-Out", desc: "View exact clock-in and clock-out times per employee with late flags." },
            { icon: TrendingUp, title: "Punctuality Tracking", desc: "Monitor attendance trends and lateness patterns across your team." },
          ].map((f) => (
