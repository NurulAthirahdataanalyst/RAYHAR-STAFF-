    ...
    <div className="space-y-6 animate-in fade-in duration-500 max-w-7xl mx-auto px-4 pt-2 pb-6">
      ...
      <div className="grid grid-cols-2 md:grid-cols-4 xl:grid-cols-7 gap-4 mb-6">
            {[
              ...
              <div key={i} className={`border border-slate-200 dark:border-slate-800 bg-white dark:bg-card rounded-xl shadow-sm hover:shadow-md p-4 flex flex-col justify-between h-[130px] transition-all duration-300`}>
