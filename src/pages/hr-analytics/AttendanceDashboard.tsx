            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <div className="relative">
                <Popover>
                  <PopoverTrigger asChild>
                    <button className="appearance-none flex items-center justify-center px-3 py-1.5 bg-slate-100 dark:bg-slate-800 border border-transparent text-slate-700 dark:text-slate-300 text-[11px] font-medium rounded-lg shadow-none outline-none cursor-pointer h-9 gap-2 hover:border-[#7B0099]/40 hover:ring-1 hover:ring-[#7B0099]/40 hover:bg-[#7B0099]/5 dark:hover:border-[#7B0099]/60 dark:hover:ring-[#7B0099]/60 dark:hover:bg-[#7B0099]/20 transition-all duration-200 focus:ring-1 focus:ring-[#7B0099]">
              ...
              {role !== "head_of_department" && (
                <Select value={selectedDepartmentFilter} onValueChange={setSelectedDepartmentFilter}>
                  <SelectTrigger className="w-[140px] h-9 text-[11px] font-medium rounded-lg border border-transparent bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 shadow-none outline-none hover:border-[#7B0099]/40 hover:ring-1 hover:ring-[#7B0099]/40 hover:bg-[#7B0099]/5 dark:hover:border-[#7B0099]/60 dark:hover:ring-[#7B0099]/60 dark:hover:bg-[#7B0099]/20 transition-all duration-200 focus:ring-1 focus:ring-[#7B0099]">
              ...
              {role !== "branch_leader" && (
                <Select value={selectedBranchFilter} onValueChange={setSelectedBranchFilter}>
                  <SelectTrigger className="w-[130px] h-9 text-[11px] font-medium rounded-lg border border-transparent bg-slate-100 dark:bg-slate-800 text-slate-700 dark:text-slate-300 shadow-none outline-none hover:border-[#7B0099]/40 hover:ring-1 hover:ring-[#7B0099]/40 hover:bg-[#7B0099]/5 dark:hover:border-[#7B0099]/60 dark:hover:ring-[#7B0099]/60 dark:hover:bg-[#7B0099]/20 transition-all duration-200 focus:ring-1 focus:ring-[#7B0099]">
