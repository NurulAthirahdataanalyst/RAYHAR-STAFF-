...
export default function WorkforceInsights() {
  ...
  const CustomDeptTooltip = ({ active, payload, label }: any) => {
    if (active && payload && payload.length) {
      return (
        <div className="bg-white dark:bg-card border border-2 border-slate-200 dark:border-slate-800 rounded-md shadow-lg p-2 flex flex-col gap-1 min-w-[100px]">
    ...
    <div className="space-y-6 animate-in fade-in duration-500 max-w-7xl mx-auto">
        ...
        <div className="flex flex-wrap items-center justify-end w-full gap-3 pb-2 pt-2">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center bg-slate-50 dark:bg-slate-900/50 rounded-lg p-1 border-2 border-slate-200 dark:border-slate-800">
                <button 
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 xl:grid-cols-5 gap-6 mb-6">
          ...
          <Card className={`col-span-1 xl:col-span-1 rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card flex flex-col p-6 justify-between ${cardHoverEffect}`}>
            <div>
          ...
          <div className="col-span-1 xl:col-span-2 grid grid-cols-1 sm:grid-cols-2 gap-4">
            ...
            <Card className={`rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card flex ${cardHoverEffect}`}>
          ...
          {['branch_leader', 'head_of_department'].includes(role) ? (
            <Card className={`col-span-1 md:col-span-2 xl:col-span-2 rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card p-5 flex flex-col justify-between ${cardHoverEffect}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
          ...
          {(() => {
            ...
            return (
              <Card className={`col-span-1 lg:col-span-2 rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card flex flex-col h-fit ${cardHoverEffect}`}>
                <CardHeader className="p-5 border-b border-slate-100 dark:border-slate-800 pb-4 flex flex-row justify-between items-center">
                  ...
                  <Select value={selectedRegion} onValueChange={setSelectedRegion}>
                    <SelectTrigger className="w-[120px] h-7 text-[10px] font-bold border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card shadow-none focus:ring-0">
                        ...
                        return (
                          <div key={idx} className="flex flex-col gap-1">
                            ...
                            <UITooltip delayDuration={100}>
                              ...
                              <TooltipContent side="top" align="center" className="bg-white dark:bg-card border border-2 border-slate-200 dark:border-slate-800 shadow-xl rounded p-3 z-50 w-max whitespace-nowrap text-left min-w-[150px]">
          ...
          <Card className={`col-span-1 rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card flex flex-col ${cardHoverEffect}`}>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
          {/* 3. Leave Monitoring */}
          <Card className={`col-span-1 rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card ${cardHoverEffect}`}>
          ...
          <Card className={`col-span-1 lg:col-span-2 rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card ${cardHoverEffect}`}>
            <CardHeader className="p-5 border-b border-slate-100 dark:border-slate-800 pb-4">
        ...
        {isAdminRole && (
          ...
          <Card className={`rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card flex flex-col p-4 ${cardHoverEffect}`}>
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3 mb-3">
              ...
              <span className="px-2 py-0.5 text-[10px] font-semibold bg-slate-50 dark:bg-slate-900/50 border border-2 border-slate-200 dark:border-slate-800 rounded text-slate-500 flex items-center gap-1">
            ...
            <Button
              ...
              className="w-full mt-4 h-9 bg-white dark:bg-card hover:bg-slate-50 dark:bg-slate-900/50 text-slate-700 font-semibold border-2 border-slate-200 dark:border-slate-800"
            >
              View All Attendance
            </Button>
          </Card>
          ...
          <Card className={`rounded-lg shadow-sm border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card flex flex-col p-4 ${cardHoverEffect}`}>
            <div className="flex items-center justify-between border-b border-slate-100 dark:border-slate-800 pb-3 mb-3">
              ...
              <Button
                onClick={() => navigate("/leave/admin?tab=pending")}
                variant="outline"
                className="h-7 px-2.5 text-[10px] font-bold border-2 border-slate-200 dark:border-slate-800 bg-white dark:bg-card text-slate-600 rounded"
              >
                View All
              </Button>
            </div>
            ...
            <div className="flex-1 space-y-3 max-h-[300px] overflow-y-auto custom-scrollbar pr-0.5">
              ...
              {pendingApprovalsList.length === 0 && feedConnected ? (
                ...
                pendingApprovalsList.map((item) => (
                  <div key={item.id} className="flex flex-col sm:flex-row sm:items-center justify-between p-3 border-2 border-slate-200 dark:border-slate-800 rounded-lg hover:bg-slate-50 dark:bg-slate-900/50 transition-all gap-3">
    ...
    <div className="space-y-8">
       ...
       <div>
         ...
         <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            <Card className="p-4 flex items-center shadow-[0_2px_10px_rgba(0,0,0,0.03)] border-2 border-slate-200 dark:border-slate-800 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-default bg-white dark:bg-card rounded-[12px] group">
            ...
            <Card className="p-4 flex items-center shadow-[0_2px_10px_rgba(0,0,0,0.03)] border-2 border-slate-200 dark:border-slate-800 hover:shadow-md hover:-translate-y-1 transition-all duration-300 cursor-default bg-white dark:bg-card rounded-[12px] group relative">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
           <Card className="p-5 shadow-sm border-2 border-slate-200 dark:border-slate-800 hover:border-[#7B0099] hover:shadow-md transition-all duration-300 flex flex-col">
       ...
       <div>
         ...
         <div className="grid grid-cols-1 lg:grid-cols-12 gap-6 mb-6">
           ...
           <Card className="lg:col-span-5 p-4 shadow-sm border-2 border-slate-200 dark:border-slate-800 hover:border-[#7B0099] hover:shadow-md transition-all duration-300 flex flex-col">
             <div className="flex justify-between items-center mb-4">
               <div className="flex items-center gap-2">
                 <Building2 className="w-4 h-4 text-slate-400" />
                 <h3 className="text-sm font-bold text-[#1A1F36]">Department Workforce Distribution</h3>
               </div>
               <div className="text-[10px] font-bold border border-2 border-slate-200 dark:border-slate-800 rounded px-2 py-1 flex items-center gap-1 text-slate-500 cursor-pointer hover:bg-slate-50 dark:bg-slate-900/50">
                 This Month <ChevronDown className="w-3 h-3" />
               </div>
             </div>
           ...
           <Card className="lg:col-span-7 p-4 shadow-sm border-2 border-slate-200 dark:border-slate-800 hover:border-[#7B0099] hover:shadow-md transition-all duration-300 flex flex-col bg-white dark:bg-card">
             <div className="flex justify-between items-center mb-4">
               <div className="flex items-center gap-2">
                 <MapPin className="w-4 h-4 text-slate-400" />
                 ...
                 return (
                   <div key={idx} className="flex flex-col gap-1">
                     ...
                     <div className="w-full bg-slate-100 dark:bg-slate-800 rounded-full h-2 relative group cursor-pointer">
                       ...
                       <div className="absolute left-1/2 -top-8 -translate-x-1/2 opacity-0 group-hover:opacity-100 transition-opacity bg-white dark:bg-card border border-2 border-slate-200 dark:border-slate-800 shadow-xl rounded p-1.5 pointer-events-none z-10 w-max whitespace-nowrap">
         ...
         <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-6">
           ...
           <Card className="p-4 shadow-sm border-2 border-slate-200 dark:border-slate-800 hover:border-[#7B0099] hover:shadow-md transition-all duration-300 flex flex-col">
             ...
             {totalLeaveCount > 0 ? (
               ...
               <div className="flex items-center justify-center flex-1 h-[140px] text-slate-400 text-xs italic bg-slate-50/50 rounded-lg border-2 border-slate-200 dark:border-slate-800 border-dashed">
           ...
           <Card className="p-4 shadow-sm border-2 border-slate-200 dark:border-slate-800 hover:border-[#7B0099] hover:shadow-md transition-all duration-300 flex flex-col relative overflow-hidden">
             {feedConnected && (
           ...
           <Card className="p-4 shadow-sm border-2 border-slate-200 dark:border-slate-800 hover:border-[#7B0099] hover:shadow-md transition-all duration-300 flex flex-col">
             ...
             <div className="grid grid-cols-2 gap-3 flex-1">
               ...
               <div className="flex flex-col justify-center items-center py-2 bg-[#F8FAFC] rounded-xl border border-2 border-slate-200 dark:border-slate-800 text-center">
       ...
       <div>
         ...
         <div className="grid grid-cols-1 gap-6">
           <Card className="p-4 shadow-sm border-l-4 border-l-[#7B0099] border-y-2 border-y-slate-200 border-r-2 border-r-slate-200 dark:border-y-slate-800 dark:border-r-slate-800 hover:border-[#7B0099] hover:shadow-md transition-all duration-300 flex flex-col">
             <div className="flex justify-between items-center mb-4">
               <div className="flex items-center gap-2">
             ...
             <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 flex-1">
               {(liveHrAlerts || hrAlerts || []).map((alert: any, i: number) => {
                 ...
                 let borderColor = 'border-2 border-slate-200 dark:border-slate-800';
