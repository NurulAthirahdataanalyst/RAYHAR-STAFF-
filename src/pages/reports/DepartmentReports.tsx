import { Building2, BarChart3, Users, Download, Construction } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mt-6 rounded-2xl overflow-hidden border border-border shadow-sm bg-card">
          ...
          <div className="p-10 flex flex-col items-center text-center gap-6">
            ...
            <div>
              <h2 className="text-2xl font-black text-foreground mb-2">Department Reports</h2>
              <p className="text-sm text-muted-foreground max-w-md">
                Department-level performance and workforce reports. Compare attendance,
                punctuality, and leave metrics across your branch or department over any period.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          {[
            { icon: Building2, title: "Branch Overview", desc: "High-level snapshot of your branch or department performance." },
            { icon: BarChart3, title: "Comparative Analysis", desc: "Compare department attendance and leave stats month over month." },
            { icon: Download, title: "Export Reports", desc: "Download department reports for management review and archiving." },
          ].map((f) => (
