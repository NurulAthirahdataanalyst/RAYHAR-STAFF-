import { CalendarDays, FileText, Download, Construction } from "lucide-react";
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="mt-6 rounded-2xl overflow-hidden border border-border shadow-sm bg-card">
          ...
          <div className="p-10 flex flex-col items-center text-center gap-6">
            ...
            <div>
              <h2 className="text-2xl font-black text-foreground mb-2">Leave Reports</h2>
              <p className="text-sm text-muted-foreground max-w-md">
                Comprehensive leave utilisation reports for your team. Track leave balances,
                approval rates, and leave type breakdowns across the month or year.
              </p>
            </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          {[
            { icon: CalendarDays, title: "Leave Utilisation", desc: "How much leave has been consumed vs remaining per employee." },
            { icon: FileText, title: "Leave Type Breakdown", desc: "Annual, medical, emergency and other leave type summaries." },
            { icon: Download, title: "Export Reports", desc: "Export leave data in Excel or PDF for HR documentation." },
          ].map((f) => (
