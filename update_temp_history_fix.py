...
def fix():
    ...
    # Match the THREE divs closing the top section
    ...
    # BUT wait! If I just drop the last </div> from active_assignment_code, it perfectly aligns!
    # Because text[match.start():] starts with the </div> that closes the card!
    end_idx = match.start()
