...
def clean_classnames(content):
    def replace_tablehead(match):
        ...
        inner = re.sub(r'\btext-(slate|gray|zinc|neutral|stone|indigo|blue|foreground)-?[0-9]*\b', '', inner)
        inner = re.sub(r'\bdark:text-(slate|gray|zinc|neutral|stone|indigo|blue|foreground)-?[0-9]*\b', '', inner)
