...
(async () => {
  try {
    console.log("Connecting to Database to update roles to proper case...");
    
    // Delete all existing roles
    await pgPool.query("DELETE FROM roles");
    console.log("Deleted old roles.");

    // Insert the specific roles requested by the user, formatted in proper case
    const exactRoles = [
      "Employee", 
      "Branch Leader", 
      "HR Admin", 
    ...
    console.log("Proper case roles inserted successfully.");
    process.exit(0);
  } catch (err) {
